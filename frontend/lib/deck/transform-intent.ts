...
export function buildTransformIntentPromptBlock(canonical: TransformIntentCanonical): string {
  ...
  const blocks: Record<TransformIntentCanonical, string> = {
    general: [
      ...
      "- Copy every unchanged card exactly from SOURCE; change only the minimum cards required.",
    ...
    improve_mana_base: [
      ...
      "- Copy every unchanged card exactly from SOURCE; change only mana-related slots unless legality forces more.",
    ...
    tighten_curve: [
      ...
      "- Copy every unchanged card exactly from SOURCE; change only the minimum cards required for curve smoothing.",
    ...
    add_interaction: [
      ...
      "- Copy every unchanged card exactly from SOURCE; change only the minimum cards required to add interaction.",
