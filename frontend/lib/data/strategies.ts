...
export const STRATEGIES: StrategyDef[] = [
  {
    slug: "ramp",
    title: "Ramp",
    tagMatches: ["ramp", "lands", "landfall", "big mana", "mana ramp", "treasure", "treasures", "mana rocks"],
  ...
  },
  {
    slug: "tokens",
    title: "Tokens",
    tagMatches: ["tokens", "anthem", "overrun", "goblins", "elves", "vampires", "zombies", "attack triggers"],
  ...
  },
  {
    slug: "sacrifice",
    title: "Sacrifice",
    tagMatches: ["sacrifice", "aristocrats", "death triggers", "lifedrain", "graveyard", "recursion", "food", "treasures"],
  ...
  },
  {
    slug: "control",
    title: "Control",
    tagMatches: ["control", "stax", "pillowfort", "politics", "tempo", "spellslinger", "removal", "counterspells"],
  ...
  },
  {
    slug: "aggro",
    title: "Aggro",
    tagMatches: ["aggro", "combat", "haste", "extra combat", "attack triggers", "combat tricks", "equipment", "vampires", "warriors"],
  ...
  },
  {
    slug: "combo",
    title: "Combo",
    tagMatches: ["combo", "creature combo", "storm", "toolbox", "untap", "bounce", "cost reduction", "reanimation"],
