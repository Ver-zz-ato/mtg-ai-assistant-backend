...
const DEFAULT_TIMEOUTS: Record<string, number> = {
  ...
  'deck_roast': 120000,   // 2 minutes - AI deck roast
  'deck_roast_mobile': 120000, // mobile structured JSON roast
  ...
  default: 120000,        // 2 minutes default for AI calls without a tighter route policy
};
