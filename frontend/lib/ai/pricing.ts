...
export function costUSD(model: string, inputTokens: number, outputTokens: number): number {
  ...
  const table: Record<string, { inPerK: number; outPerK: number }> = {
    "gpt-5.5": { inPerK: 0.005, outPerK: 0.03 },        // $5/1M in, $30/1M out
    "gpt-5.4-mini": { inPerK: 0.00075, outPerK: 0.0045 }, // $0.75/1M in, $4.50/1M out
    "gpt-5.4-nano": { inPerK: 0.00015, outPerK: 0.00075 },
    "gpt-5.4": { inPerK: 0.0025, outPerK: 0.015 },      // $2.50/1M in, $15/1M out
