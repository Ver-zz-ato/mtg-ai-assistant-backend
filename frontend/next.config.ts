...
export default withSentryConfig(nextConfig, {
  ...
  // Direct client telemetry to Sentry. The same-origin tunnel was forwarding large auth cookies
  // through /monitoring and triggering intermittent 400 "Request Header Or Cookie Too Large" responses.
  tunnelRoute: false,
