...
-- ---------------------------------------------------------------------------
-- scryfall_cache: keep public read; service role only for writes
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- price_cache: keep public read; service role only for writes
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- card_embeddings: keep public read; service role only for writes
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- shoutbox_messages: public read; API persists via service role
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- user_prompt_variant: service role inserts only (no client writers)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- price_snapshots: public read; service role for writes/deletes
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- scan-index storage: public object read by path (no bucket listing)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Function search_path (advisor 0011)
-- ---------------------------------------------------------------------------
DO $$
DECLARE
  fn regprocedure;
