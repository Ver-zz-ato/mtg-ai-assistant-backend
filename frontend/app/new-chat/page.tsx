...
export default function NewChatPage() {
  return (
    <div className="max-w-[1400px] mx-auto">
      <header className="relative overflow-hidden rounded-2xl border border-neutral-800 bg-gradient-to-br from-violet-900/25 via-fuchsia-900/15 to-cyan-900/20 p-5 sm:p-6 mb-4">
