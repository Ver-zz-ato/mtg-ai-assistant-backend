...
const JOURNEY: JourneyStage[] = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        title: "Playstyle Quiz",
        subtitle: "Find your Commander or constructed style, then open the right builder.",
        badge: "Limited",
        icon: Bot,
        accent: "text-cyan-200 border-cyan-300/25 bg-cyan-300/10",
      },
      {
        href: "/tools/custom-card",
        title: "Custom Card Creator",
        subtitle: "Generate, edit, save, and share a fan-made profile card.",
        badge: "Limited",
        icon: Sparkles,
  ...
  },
  {
    ...
    tools: [
      ...
      {
        href: "/tools/finish-deck",
        title: "Complete This Deck",
        subtitle: "Turn a partial saved or pasted list into a finished deck plan.",
        badge: "Limited",
        icon: Wrench,
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        href: "/inbox",
        title: "Inbox",
        subtitle: "See comments on your public decks, binders, reports, and custom cards.",
        badge: "Sign in",
        icon: BookOpen,
        accent: "text-cyan-200 border-cyan-300/25 bg-cyan-300/10",
      },
