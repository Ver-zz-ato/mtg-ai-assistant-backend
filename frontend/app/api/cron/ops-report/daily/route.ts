...
const JOB_ID = "daily_ops_report";

export async function GET(req: NextRequest) {
  if (!verifyCronRequest(req, { routePath: "/api/cron/ops-report/daily" })) {
  ...
  try {
    ...
    console.error("[ops-report:daily]", e);
