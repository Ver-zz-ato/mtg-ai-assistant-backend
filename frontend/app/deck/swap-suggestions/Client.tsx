...
export default function BudgetSwapsClient(){
  ...
  return (
    <div className="w-full">
      ...
      <header className="sticky top-0 z-[5] relative overflow-hidden rounded-t-2xl border-b border-neutral-800 bg-gradient-to-br from-purple-900/20 via-pink-900/10 to-rose-900/20 backdrop-blur-sm p-6 -mx-4 sm:mx-0">
        <div className="relative z-10">
          ...
          <p className="text-base text-neutral-300 max-w-4xl leading-relaxed">
            Find powerful budget alternatives to expensive cards. Get AI-powered suggestions or rules-based swaps to keep your deck competitive without breaking the bank. Compare prices, track trends, and export to Moxfield.
          </p>
