...
export default function MyDecksError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[My Decks Page Error]', error);
  }, [error]);
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8">
      <div className="text-center py-16">
        ...
        <h1 className="text-2xl font-bold text-white mb-2">Unable to load your decks</h1>
        <p className="text-neutral-400 mb-6">
          We had trouble loading your deck collection. This might be a temporary issue.
        </p>
