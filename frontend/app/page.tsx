    ...
    <>
      ...
      <div className="w-full relative">
        ...
        <div className="max-w-[1600px] mx-auto px-4 py-0 grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <section className="col-span-1 md:col-span-7 xl:col-span-7 flex flex-col gap-3 pt-2" data-chat-area>
        ...
        {/* SEO nav links - flex-wrap for predictable wrapping on narrow screens */}
        <nav className="max-w-[1600px] mx-auto px-4 py-3 mt-2 border-t border-neutral-800 flex flex-wrap justify-center gap-x-2 gap-y-1.5 text-sm" aria-label="Tools and discovery">
          <a href="/tools/mulligan" className="text-amber-400 hover:text-amber-300 transition-colors">Mulligan</a>
          <span className="text-neutral-600 shrink-0" aria-hidden>·</span>
