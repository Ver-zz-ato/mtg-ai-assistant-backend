...
import DeckHealthCard from "./DeckHealthCard";  // <-- add this

export default function Chat() {
  const [messages] = useState([
    { role: "user", content: "Analyze this Yuriko deck and suggest 3 cheap upgrades." },
    { role: "assistant", content: "Quick scan:\n• Low curve; draw a bit thin.\n• Add 1–2 cheap ninjutsu enablers." },
  ]);
        ...
        {messages.map((m, i) => (
          <div key={i} className="mb-4">
            <div className={m.role === "user"
                ? "inline-block bg-gray-800 rounded-xl px-4 py-3"
