      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full px-4 py-2 rounded-lg border border-indigo-500/40 bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-200 text-sm font-semibold text-center transition-colors"
            onClick={() => { try { capture('discord_join_clicked', { location: 'email_verified' }); } catch {} }}
          >
            Join the ManaTap Discord
          </a>
        </div>
      </div>
    </div>
