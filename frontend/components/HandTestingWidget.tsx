    ...
    return (
      <div className={`bg-gradient-to-br from-amber-900/20 to-amber-800/10 border border-amber-700/40 rounded-lg p-4 ${className}`}>
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="font-semibold text-amber-200">Hand Testing Widget - PRO Feature</h3>
            <p className="text-sm opacity-80">Test opening hands with realistic mulligan decisions</p>
            <p className="text-xs text-amber-300 mt-1">
              You've used your 3 free runs. Upgrade to Pro for unlimited access to advanced deck testing tools!
            </p>
          </div>
        ...
        <div className="mb-4 p-3 bg-amber-950/30 rounded-lg border border-amber-700/30">
          <p className="text-sm font-semibold text-amber-200 mb-2">What you're missing:</p>
        ...
        <div className="text-center">
          <button 
            ...
            className="px-6 py-3 bg-gradient-to-r from-amber-600 to-amber-500 text-black font-semibold rounded-lg hover:from-amber-500 hover:to-amber-400 transition-all duration-200 transform hover:scale-105 shadow-lg"
          >
            Upgrade to Pro - Just £1.99/mo
          </button>
          <p className="text-xs opacity-70 mt-2 text-amber-200">
            Plus unlimited AI analysis, price tracking, and all Pro features
          </p>
        </div>
      </div>
    );
