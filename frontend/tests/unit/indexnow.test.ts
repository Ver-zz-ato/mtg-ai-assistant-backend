...
async function main() {
  try {
    mutableEnv.INDEXNOW_KEY = "dedc0b967a2b4916baed8a40404ce092";
    mutableEnv.INDEXNOW_ENABLED = "false";
    mutableEnv.NEXT_PUBLIC_SITE_URL = "https://www.manatap.ai";
    ...
    delete mutableEnv.INDEXNOW_ENABLED;
