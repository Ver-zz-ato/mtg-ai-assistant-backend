...
- Host start/advance routes accept optional manual 1v1 pairings or Commander pod assignments. Round Robin stays automatic; Top Cut and later elimination bracket rounds advance winners automatically. Swiss rematches require an explicit `allowRematches` confirmation.
